...
public class Controller {
    ...
    Image AppIcon = new Image("Util/icon/app_mini.png");
    Image PassIcon = new Image("Util/icon/passport_mini.png");
    Image GiftIcon = new Image("Util/icon/giftcard_mini.png");
    Image VipIcon = new Image("Util/icon/vipcard_mini.png");
...
//        left_view.getSelectionModel().selectedIndexProperty().addListener(((observable, oldValue, newValue) -> {
//            if (newValue.intValue()==0) {
//                ArrayList<Password> Login = new ArrayList<>(10);
//                for (Password i : Main.user.all_passwords) {
//                    if (i.tag.equals("Login")) {
...
//        }));
        ...
        choice_list.getSelectionModel().selectedIndexProperty().addListener((observable, oldValue, newValue) -> {
            ...
            } else if (oldValue.equals(newValue)|| oldValue == null) {
